...
//https://github.com/Muhammadhassaankhan/Collections-and-Enums-Mini-HW-Hassaan-413.git this is the url of my  git repository
...
public class CreateTeam {
    public static void main(String[] args) {
        ...
        List<Person> peopleData = readDataFromExcelFile("myfile/MOCK_DATA.xlsx");
